...
const QuizNavigator = memo(function QuizNavigator({ questions, answers, currentIndex, onNavigate }) {
  ...
  return (
    <div className="bg-white/10 backdrop-blur-md rounded-2xl shadow-2xl p-6 sticky top-8">
      <h3 className="text-white font-bold text-xl mb-4">Questions</h3>
        ...
        {visibleQuestions.map((idx) => {
          ...
          return (
            <button
              ...
              className={`
                aspect-square rounded-lg font-semibold text-base transition-all
      ...
      {showPagination && totalPages > 1 && (
        <div className="mb-4 pb-4 border-b border-white/20">
          <div className="flex items-center justify-between text-base text-gray-400 mb-2">
          ...
          <div className="flex gap-2">
            <button
              ...
              className="flex-1 px-3 py-2 bg-white/10 text-white text-base rounded-lg hover:bg-white/20 transition-all disabled:opacity-50 disabled:cursor-not-allowed"
            >
              Previous
            </button>
            <button
      ...
      {/* Legend */}
      <div className="mt-6 pt-4 border-t border-white/20 space-y-2 text-base">
