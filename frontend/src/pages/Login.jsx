...
import { User, Lock, Terminal, Shield, ArrowRight, Activity } from "lucide-react";
...
export default function Login({ onLogin }) {
  ...
  const [terminalLogs, setTerminalLogs] = useState([
    { type: "info", text: "codoai_console --init" },
    { type: "success", text: "[OK] Connection to Piston API established." },
    { type: "info", text: "Calibrating compiler pipelines: Python, C++, Java..." },
    { type: "success", text: "[OK] Environment calibrated." },
    { type: "user", text: "Awaiting authentication handshake..." }
  ]);

  const mockLogPool = [
    { type: "info", text: "Compiling Reverse String (Python) - Round 1..." },
    { type: "success", text: "[COMPILE SUCCESS] 10 XP Gained." },
    { type: "info", text: "Analyzing syntax structures..." },
    { type: "warn", text: "[WARN] Spot logic error: missing list boundaries." },
    { type: "info", text: "Streak count active: 7 days (+1.5x active multipliers)." },
    { type: "success", text: "[XP BOOST] User level calibrated: Level 3." },
    { type: "info", text: "Testing Piston Sandbox environment..." },
    { type: "success", text: "[OK] Sandbox verified." },
    { type: "user", text: "Listening on auth stream port 5173..." }
  ];
          ...
          >
            ...
            <div className="flex items-center justify-between border-b pb-2 mb-3" style={{ borderColor: 'var(--border-color)' }}>
              <div className="flex items-center gap-1.5">
                ...
                <span className="text-[10px] font-bold uppercase ml-2 text-gray-500">compiler_diagnostics_stream</span>
              </div>
        ...
        <div className="col-span-1 md:col-span-6 lg:col-span-5 w-full">
          <div className="p-6 cc-card backdrop-blur-md relative overflow-hidden">
            ...
            <p className="text-xs mb-5" style={{ color: 'var(--text-tertiary)' }}>
              Join the compiler pipelines and analyze files.
            </p>

            {/* Autofill helper pill */}
            <div className="flex items-center justify-between p-2.5 rounded-xl border border-dashed mb-5" style={{ borderColor: 'var(--border-light)', backgroundColor: 'var(--bg-tertiary)' }}>
              <span className="text-[10px] font-bold uppercase tracking-wider" style={{ color: 'var(--text-tertiary)' }}>Testing bypass</span>
              <button
                type="button"
                onClick={() => {
                  setUsername("admin");
                ...
                className="text-[9px] font-extrabold uppercase tracking-widest px-2.5 py-1 rounded bg-[var(--accent-soft)] hover:bg-[rgba(99,102,241,0.25)] text-[var(--accent-primary)] cursor-pointer border border-transparent transition-all hover:scale-105"
              >
                ⚡ Autofill Admin
              </button>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="flex flex-col gap-1.5 text-left">
                ...
                <div className="relative">
                  ...
                  <input
                    type="text"
                    className="w-full rounded-xl border pl-10 pr-4 py-2.5 text-sm outline-none transition-all focus:border-[var(--accent-primary)]"
              ...
              >
                {isLoading ? "Validating handshake..." : (
            ...
            <div className="mt-5 text-center text-xs" style={{ color: 'var(--text-tertiary)' }}>
              ...
              <Link to="/register" className="cc-link font-bold uppercase tracking-wider hover:underline ml-1">
                Sign Up
              </Link>
            </div>
          </div>
