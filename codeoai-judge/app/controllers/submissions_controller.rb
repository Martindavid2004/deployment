class SubmissionsController < ApplicationController
  ...
  def create
    ...
    if submission.save
      if @wait
        begin
          # Use our simple executor instead of isolate
          result = SimpleExecutor.execute(
          ...
          submission.update(
            ...
            status: Status.find_by(name: result[:status]) || Status.ac,
        ...
        # For async execution, we'd queue a job here
