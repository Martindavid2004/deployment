...
print(f"[INIT] Problem Generator - Google API Key configured: {bool(api_key)}; google lib available: {genai is not None}")
...
if api_key and genai is not None:
    ...
    if not api_key:
        ...
        print(f"[WARNING] google.generativeai library not installed - will use fallback problems")
